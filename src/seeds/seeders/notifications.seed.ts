  ...
  [NotificationType.REGISTRATION_CONFIRMATION]: [
    {
      ...
      message:
        'Your registration for {tournament} has been received and is pending review.',
    },
  ],
  [NotificationType.REGISTRATION_APPROVED]: [
    {
      title: 'Registration Approved!',
      message: 'Your club registration for {tournament} has been approved.',
    },
    {
      title: 'Welcome to the Tournament',
      message: 'Great news! Your team is registered for {tournament}.',
    },
  ],
  [NotificationType.REGISTRATION_REJECTED]: [
    {
      ...
      message:
        'Unfortunately, your registration for {tournament} was not approved.',
    },
    {
      title: 'Registration Status Update',
      message: 'Your registration for {tournament} has been declined.',
    },
  ],
  ...
  [NotificationType.TOURNAMENT_CANCELLED]: [
    {
      ...
      message: '{tournament} has been cancelled. Check for refund details.',
    },
  ],
  [NotificationType.TOURNAMENT_UPDATE]: [
    {
      title: 'Tournament Update',
      message: "There's an update for {tournament}. Check the details.",
    },
    {
      title: 'Schedule Change',
      message: 'The schedule for {tournament} has been updated.',
    },
  ],
  [NotificationType.GROUP_DRAW]: [
    {
      title: 'Draw Completed',
      message: 'The draw for {tournament} is complete. Check your group!',
    },
    {
      title: 'Groups Announced',
      message:
        "Groups have been drawn for {tournament}. See who you're playing!",
    },
  ],
  [NotificationType.PAYMENT_REMINDER]: [
    {
      title: 'Payment Reminder',
      message: "Don't forget to complete your payment for {tournament}.",
    },
  ],
  [NotificationType.PAYMENT_COMPLETED]: [
    {
      title: 'Payment Confirmed',
      message: 'We received your payment of {amount} for {tournament}.',
    },
    {
      title: 'Payment Successful',
      message: 'Your payment for {tournament} has been processed successfully.',
    },
  ],
  [NotificationType.PAYMENT_FAILED]: [
    {
      title: 'Payment Failed',
      message: 'Your payment for {tournament} could not be processed.',
    },
    {
      title: 'Payment Issue',
  ...
  [NotificationType.NEW_TOURNAMENT_MATCH]: [
    {
      ...
      message:
        'Your next match in {tournament} is scheduled. Check the details!',
    },
  ],
  [NotificationType.SYSTEM]: [
    {
      title: 'System Notification',
      message: 'Important system update. Please review.',
    },
    {
    ...
    },
    {
      title: 'Welcome!',
      message:
        'Welcome to Football Tournament Platform! Start by creating your club.',
    },
  ],
};
  ...
  for (const userId of userIds) {
    ...
    for (let i = 0; i < notificationCount; i++) {
      ...
      const tournamentName =
        pickRandom(tournamentNamesArray) || 'Summer Cup 2024';
