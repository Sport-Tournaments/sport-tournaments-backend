...
const TOURNAMENTS: {
...
}[] = [
  {
    ...
    groupsCount: null,
    teamsPerGroup: 4,
    description: 'Single Elimination – 16 teams, straight bracket, no second chances.',
  },
  {
    ...
    groupsCount: null,
    teamsPerGroup: 4,
    description: 'Double Elimination – 16 teams, winners & losers bracket.',
  },
  {
    ...
    groupsCount: null,
    teamsPerGroup: 4,
    description: 'Round Robin – 8 teams, all-play-all, ranked by points.',
  },
  {
    ...
    groupsCount: 4,
    teamsPerGroup: 4,
    description: 'Groups + Knockout – 16 teams split into 4 groups, top 2 advance.',
  },
  {
    id: '33000000-0000-0000-0000-000000000005',
    ageGroupId: '44000000-0000-0000-0000-000000000005',
    name: 'League Cup 2026',
    format: 'LEAGUE',
    teamCount: 12,
    startOffset: 58,
    groupsCount: null,
    teamsPerGroup: 4,
    description: 'League – 12 teams, home & away fixtures, season standings.',
  },
];
